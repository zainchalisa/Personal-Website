...
import runFrame2Url from '../../assets/run 2.png'
import avatarUrl from '../../assets/avatar.png'
import cloudUrl from '../../assets/cloud-pixel.png'
import fallingUrl from '../../assets/falling.png'
import onGroundUrl from '../../assets/on the ground.png'
import platformLeftUrl from '../../assets/volcano/volcano_pack_alt_19.png'
import platformRightUrl from '../../assets/volcano/volcano_pack_alt_40.png'
import lightBgUrl from '../../assets/bg_lightmode.png'
import darkBgVolcanoUrl from '../../assets/volcano/bg_volcano.png'
import floorSurfaceUrl from '../../assets/volcano/volcano_pack_53.png'
import floorFillUrl from '../../assets/volcano/volcano_pack_54.png'
import decoTreeUrl from '../../assets/volcano/volcano_pack_59.png'
import decoPurpleCrystalUrl from '../../assets/volcano/volcano_pack_56.png'
import decoOrangeCrystalUrl from '../../assets/volcano/volcano_pack_65.png'
import decoBushUrl from '../../assets/volcano/volcano_pack_73.png'
import decoRocksUrl from '../../assets/volcano/volcano_pack_70.png'
import decoRockUrl from '../../assets/volcano/volcano_pack_71.png'
import portalGifUrl from '../../assets/portal_pixel_art_by_fabian8bit_dfalvdy-ezgif.com-gif-maker.gif'
...
const platformCenterGlob = import.meta.glob<string>(
  '../../assets/volcano/volcano_pack_alt_41.png',
...
export function ProjectsGame({ projects, theme, active }: ProjectsGameProps) {
  ...
  useEffect(() => {
    ...
    function drawPortalLabelOn(fx: CanvasRenderingContext2D, p: Portal, pal: Palette) {
      const cx = p.x - Math.round(camX)
      drawPortalLabel(fx, cx, p.y, p.proj.name, p.proj.route, p.active, pal)
    }
