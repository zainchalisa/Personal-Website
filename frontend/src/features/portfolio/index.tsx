...
import { schedulePhotographyWarmPrefetch } from '@/features/photography/components/photographyPrefetch'
import { prefersMobileLayout, useMobileLayout } from '@/hooks/useMobileLayout'
...
export function PortfolioPage() {
  ...
  useEffect(() => {
    schedulePhotographyWarmPrefetch(isPhone)
  }, [isPhone])
