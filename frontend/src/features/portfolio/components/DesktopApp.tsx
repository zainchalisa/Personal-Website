import { prefetchPhotographyAppAssets } from '@/features/photography/components/photographyPrefetch'
...
export function DesktopApp({
  ...
  return (
    <button
      ...
      onMouseEnter={variant === 'photography' ? () => prefetchPhotographyAppAssets() : undefined}
